...
import { Email_Regex_Validation, Password_Regex_Validation, Phone_Regex_Validation } from "./lib";
import "./App.css";
      ...
      <form className="form-item" onSubmit={handleSubmit(onSubmit)}>
        ...
        <section className="form-flex">
          <div className="form-flex-1">
            ...
            />
            {errors.firstName && (<p className="error">Minimum of 3 characters</p>)}
          </div>
          ...
          <div className="form-flex-1">
            ...
            />
            {errors.lastName && (<p className="error">Minimum of 3 characters</p>)}
          </div>
        </section>
        ...
        <section className="form-flex-1">
          ...
          <input
            ...
            className="txt-field"
            id="phone"
            {...register("phone", { required: true, pattern: Phone_Regex_Validation })}
          />
        ...
        <section className="form-flex-1">
          ...
          />
          {errors.password && (<p className="error">Password must contain at least a digit, special symbol, Uppercase, Lowercase and 8-10 characters long.</p>)}
        </section>
        ...
        <section>
          <button
            type="submit"
            className={Object.keys(errors).length === 0 ? "form-btn-1" : "form-btn"}
            id="submit_btn"
          >
            Send message
          </button>
